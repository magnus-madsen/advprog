...
in $\Pi$ obtained by an in-order, left-to-right traversal of a provenance tree
for $A$.
...
\begin{itemize}
    ...
    \item A \textbf{provenance path} is the sequence of facts obtained by an
    in-order, left-to-right traversal of a provenance tree.
